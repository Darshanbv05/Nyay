...
export default function UploadBox({ onReady }) {
  ...
  return <section className="panel upload-panel" aria-labelledby="upload-title">
    <div className="step-label">Step 1 of 2</div><h2 id="upload-title">Add your agreement or legal document</h2><p className="muted">Any agreement can be screened through the general Indian-law baseline; rental, loan, employment, and service agreements also receive type-specific checks. Your document is not stored after analysis.</p>
