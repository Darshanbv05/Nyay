const templates = {
  ...
  bn: { hello: 'প্রিয় সংশ্লিষ্ট পক্ষ,', intro: 'প্রস্তাবিত চুক্তির নিচের শর্তগুলো সম্পর্কে আমি ব্যাখ্যা ও পরিবর্তন চাইছি:', close: 'স্বাক্ষরের আগে অনুগ্রহ করে এই পরিবর্তনগুলো লিখিতভাবে নিশ্চিত করুন। আশা করি আমরা ন্যায্যভাবে বিষয়গুলো সমাধান করে স্পষ্ট ও পারস্পরিকভাবে সম্মত শর্তে এগোতে পারব।\n\nবিনীত,' }
};
