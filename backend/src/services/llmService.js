...
const copy = {
  ...
  bn: { clear: 'এই ধারাটি পর্যালোচিত নিয়মভাণ্ডারের কোনো পরিচিত সতর্কতার সঙ্গে মেলেনি।', action: 'একটি কপি রাখুন এবং কোনো ভাষা অস্পষ্ট হলে স্বাক্ষরের আগে ব্যাখ্যা চান।', summary: 'এই নথিতে পক্ষগুলোর প্রধান শর্তগুলো উল্লেখ করা হয়েছে। নিচের ধারাগুলো, বিশেষত ঝুঁকি হিসেবে চিহ্নিত ধারাগুলো, ভালোভাবে পর্যালোচনা করুন। স্বাক্ষরের আগে অর্থ, তারিখ, দায়িত্ব, প্রতিকার ও নোটিশের সময়সীমা লিখিতভাবে নিশ্চিত করুন।', means: 'উল্লিখিত নিয়ম অনুযায়ী যাচাইকৃত নিয়মভাণ্ডারের বর্ণনা অনুসারে বিষয়টি পরীক্ষা করা প্রয়োজন।' }
};
